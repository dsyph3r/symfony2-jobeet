...
/**
 * @orm:Entity
 * @orm:Entity(repositoryClass="Dsyph3r\JobeetBundle\Repository\JobRepository")
 */
class Job
{
    /**
     ...
     * Set category
     *
     * @param Dsyph3r\JobeetBundle\Entity\Category $category
     */
    public function setCategory(\Dsyph3r\JobeetBundle\Entity\Category $category)
    {
     ...
     * Get category
     *
     * @return Dsyph3r\JobeetBundle\Entity\Category $category
     */
